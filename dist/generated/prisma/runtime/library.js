...
var Al = A(nn()), Hn = class {
    ...
    #e() { let r = []; return this.tracingHelper.isEnabled() && r.push("tracing"), this.logLevel && r.push(this.logLevel), this.logQueries && r.push("query"), r; }
};
...
var fo = "This request could not be understood by the server", St = class extends $ {
    ...
    code = "P5000";
    constructor(r, t, n) { super(t || fo, R(r, !1)), n && (this.code = n); }
};
...
var Nl = 3, Mt = N("prisma:client:dataproxyEngine"), $t = class {
    ...
    startPromise;
    protocol;
    constructor(r) { Dl(r), this.config = r, this.env = r.env, this.inlineSchema = Il(r.inlineSchema), this.inlineDatasources = r.inlineDatasources, this.inlineSchemaHash = r.inlineSchemaHash, this.clientVersion = r.clientVersion, this.engineHash = r.engineVersion, this.logEmitter = r.logEmitter, this.tracingHelper = r.tracingHelper; }
